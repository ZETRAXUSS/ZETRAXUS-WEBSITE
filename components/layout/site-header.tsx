        ...
        <div className="flex items-center gap-2.5">
          ...
          {user && profile ? (
            ...
            <div className="hidden items-center gap-2 md:flex">
              <Link
                href="/auth/login"
                className="h-9 px-4 flex items-center rounded-full border border-white/[0.12] bg-white/[0.025] text-[10px] font-semibold uppercase tracking-[1px] text-white/60 transition-all duration-300 hover:border-white/30 hover:bg-white/[0.06] hover:text-white"
              >
                Sign in
              </Link>
              <Link
                href="/auth/register"
                className="h-9 px-4 flex items-center rounded-full border border-white/25 bg-white text-black text-[10px] font-semibold uppercase tracking-[1px] transition-all duration-300 hover:bg-white/90 hover:shadow-[0_0_20px_rgba(255,255,255,0.2)]"
              >
                Register
              </Link>
            </div>
